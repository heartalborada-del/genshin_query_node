...
class bulid {
    bulidUserInfo = ({ json }) => {
        ...
        for (var i in world_explorations) {
            ...
            var offeringLevel = ''
            var offeringIcon = ''
            if (world_explorations[i].offerings.length >= 1) {
                offeringName = world_explorations[i].offerings[0].name
                offeringLevel = world_explorations[i].offerings[0].level
                offeringIcon = world_explorations[i].offerings[0].icon
            }
            if (offeringName == '') {
                worldExploration[i] = {
                    ...
                    'background_image': world_explorations[i].background_image,
                    'offering': {}
                }
            } else {
                worldExploration[i] = {
